...
const translations: Record<Language, TranslationMap> = {
  en: {
    ...
    'settings.familyPhones': 'Family phones',
    'settings.mainPhone': 'Main phone',
    'settings.secondaryPhone': 'Secondary phone',
    'settings.addSecondary': 'Add secondary phone',
    'settings.addButton': 'Add',
    'settings.secondary.error': 'Could not add secondary phone.',
    'settings.secondary.removeError': 'Could not remove secondary phone.',
    'reports.total': 'Total spending',
    'reports.avgTicket': 'Average ticket',
    'reports.topCategory': 'Top category',
    'reports.biggestExpense': 'Biggest expense',
    'reports.byCategory': 'Spend by category',
    'reports.topMerchants': 'Top merchants',
    'reports.periodMode': 'Period mode',
    'reports.periodYear': 'Yearly',
    'reports.periodRange': 'Date range',
    'reports.year': 'Year',
  ...
  es: {
    ...
    'settings.familyPhones': 'Teléfonos familiares',
    'settings.mainPhone': 'Teléfono principal',
    'settings.secondaryPhone': 'Teléfono secundario',
    'settings.addSecondary': 'Agregar teléfono secundario',
    'settings.addButton': 'Agregar',
    'settings.secondary.error': 'No se pudo agregar el teléfono secundario.',
    'settings.secondary.removeError': 'No se pudo eliminar el teléfono secundario.',
    'reports.total': 'Gasto total',
    'reports.avgTicket': 'Ticket promedio',
    'reports.topCategory': 'Categoría principal',
    'reports.biggestExpense': 'Gasto más alto',
    'reports.byCategory': 'Gasto por categoría',
    'reports.topMerchants': 'Comercios principales',
    'reports.periodMode': 'Modo de período',
    'reports.periodYear': 'Anual',
    'reports.periodRange': 'Rango de fechas',
    'reports.year': 'Año',
    'reports.startDate': 'Desde',
    'reports.endDate': 'Hasta',
